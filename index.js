		...
		try {
			...
			switch(command) {
				...
				case 'porno':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'FDP,AKI NN PODE NN KKKK🙄'})
					break
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/a/QLZZJJa`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* 𝑲𝑰𝑹𝑰𝑻𝑶 𝑶𝑭 𝑺𝑨𝑫ッ\n*WPP:* wa.me/+5511991796330\n*INSTA *OFF \n\n\n*Digite *.bot* para ver comandos basicos para criar um bot'})
					break
				case 'belle2':
					memein = await kagApi.memeindo()
				...
				case 'bot':
			     	memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/a/2TDUzqs`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: ''})
					break
				case 'belle3':
					memein = await kagApi.memeindo()
				...
				case 'bomdia':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/a/SJQEOvk`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Bom dia, coidei puto kk ❤️'})
					break
				case 'boatarde':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/a/f8vepNG`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'já ta de tarde?? '})
					break
				case 'boanoite':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/a/42KIId2`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: 'to com sono fml '})
					break
				case 'belle':
					memein = await kagApi.memeindo()
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do KIRITO:*\n\n https://bit.ly/3iIlHmc'})
					break
				case 'mia1':
					memein = await kagApi.memeindo()
